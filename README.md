...
1. **Security concepts** → `CS50/01-passwords.md` then `CS50/02-cryptography.md`
2. **How networks work** → `TryHackMe/01-network-basics.md` through `TryHackMe/05-dns.md`
3. **Linux command line** → `OverTheWire/bandit-notes.md`
4. **C programming basics** → `CS50/03-c-basics.md`
...
└── OverTheWire/
    ├── bandit-notes.md
    └── bandit-passwords.md  ← not committed (see .gitignore)
```
