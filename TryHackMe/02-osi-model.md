...
**TCP** - reliable, ordered, connection-based. Resend lost data. Uses for files etc.

**UDP** - fast, connectionless, no delivery guarantee. Used where speed matters more than reliability, video streaming, live transmission etc.
